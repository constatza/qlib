...
experiments_dir = "/home/archer/code/quantum/experiments/"


input_path_vqls_parameters = os.path.join(experiments_dir, "custom4x4/results/coarse/OptimalParameters.out")
